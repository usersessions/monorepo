...
StoryBrand exactly; CTA verbatim ×3; competitor scan + real dogfood report; real
screenshots; zero fabricated numbers; name decision confirmed; store listing with minimal-permissions privacy policy.
